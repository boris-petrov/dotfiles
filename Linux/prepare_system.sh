...
apacman -S archlinux-keyring \
  ...
  pidgin skype-secure purple-skypeweb-git purple-hangouts-hg purple-facebook-git kbdd-git pidgin-otr \
...
sudo npm install -g gulp grunt coffeescript iced-coffee-script npm-check-updates bower diff-so-fancy
